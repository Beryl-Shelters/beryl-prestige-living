...
const styles = StyleSheet.create({
  ...
  pills: { flexDirection: "row", flexWrap: "wrap", alignItems: "flex-start", gap: 8 }, pill: { minHeight: 42, maxWidth: "100%", flexShrink: 0, borderWidth: 1, borderColor: colors.line, borderRadius: radii.pill, paddingHorizontal: 15, paddingVertical: 10, alignItems: "center", justifyContent: "center", backgroundColor: colors.white }, pillOn: { borderColor: colors.brown, backgroundColor: colors.cream }, pillText: { flexShrink: 1, fontSize: 12, lineHeight: 17, color: colors.muted }, pillTextOn: { color: colors.brown, fontWeight: "800" },
