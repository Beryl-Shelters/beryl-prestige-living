...
const styles = StyleSheet.create({
  ...
  pills: { flexDirection: "row", flexWrap: "wrap", alignItems: "flex-start", gap: 8 }, pill: { minHeight: 42, maxWidth: "100%", flexShrink: 1, borderWidth: 1, borderColor: colors.line, borderRadius: radii.pill, paddingHorizontal: 13, paddingVertical: 10, alignItems: "center", justifyContent: "center", backgroundColor: colors.white }, pillOn: { borderColor: colors.brown, backgroundColor: colors.cream }, pillText: { flexShrink: 1, fontSize: 12, lineHeight: 17, color: colors.muted }, pillTextOn: { color: colors.brown, fontWeight: "800" },
  bottom: { paddingTop: spacing.md, paddingHorizontal: spacing.md, borderTopWidth: 1, borderTopColor: colors.line, flexDirection: "row", alignItems: "center", gap: 10, backgroundColor: colors.canvas }, draft: { flex: 1, minHeight: sizes.button, alignItems: "center", justifyContent: "center" }, draftText: { fontSize: 14, fontWeight: "800", color: colors.brown }, primary: { flex: 1.35, minHeight: sizes.button, borderRadius: radii.pill, alignItems: "center", justifyContent: "center", backgroundColor: colors.brown }, primaryText: { fontSize: 15, fontWeight: "800", color: colors.white },
