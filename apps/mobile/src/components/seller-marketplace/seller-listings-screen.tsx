...
const styles = StyleSheet.create({
  ...
  addButton: { minHeight: 42, paddingHorizontal: 13, borderRadius: radii.pill, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 5, backgroundColor: colors.brown }, addText: { fontSize: 12, fontWeight: "800", color: colors.white },
  ...
  badge: { alignSelf: "flex-start", maxWidth: "100%", paddingHorizontal: 8, paddingVertical: 4, borderRadius: radii.pill, fontSize: 9, fontWeight: "900", overflow: "hidden" }, liveBadge: { color: colors.success, backgroundColor: colors.verifiedBackground }, rejectedBadge: { color: colors.danger, backgroundColor: "#fde7e9" }, reviewBadge: { color: "#965b0d", backgroundColor: colors.softOrange }, draftBadge: { color: colors.muted, backgroundColor: colors.field },
  ...
  rowAction: { marginTop: 11, minHeight: 42, paddingHorizontal: 4, borderTopWidth: 1, borderTopColor: colors.line, flexDirection: "row", alignItems: "flex-end", justifyContent: "flex-end", gap: 4 }, rowActionText: { fontSize: 12, fontWeight: "800", color: colors.brown }
});
