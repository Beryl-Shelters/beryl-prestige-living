...
const actionRoutes: Record<NextAction, Href> = { VERIFY_EMAIL: "/verify-email", COMPLETE_BUYER_ONBOARDING: "/buyer", COMPLETE_SELLER_ONBOARDING: "/seller", OPEN_BUYER_DASHBOARD: "/marketplace", OPEN_SELLER_DASHBOARD: "/seller-dashboard" };
