...
export function runSuites(suites = ["auth", "dashboard", "listings", "analytics", "messages", "properties", "referrals", "settings", "kyc", "landing", "public-pages", "public-analytics", "public-referrals", "public-support", "public-buy", "public-header", "saved-properties"]) {
  for (const suite of suites) {
    if (!["auth", "dashboard", "listings", "analytics", "messages", "properties", "referrals", "settings", "kyc", "landing", "public-pages", "public-analytics", "public-referrals", "public-support", "public-buy", "public-header", "saved-properties"].includes(suite)) throw new Error(`Unknown suite: ${suite}`);
