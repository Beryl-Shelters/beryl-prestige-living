...
export function runSuites(suites = ["auth", "dashboard", "listings", "analytics"]) {
  for (const suite of suites) {
    if (!["auth", "dashboard", "listings", "analytics"].includes(suite)) throw new Error(`Unknown suite: ${suite}`);
