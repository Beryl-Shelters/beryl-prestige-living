...
export function runSuites(suites = ["auth", "dashboard", "listings", "analytics", "messages", "properties", "referrals", "settings"]) {
  for (const suite of suites) {
    if (!["auth", "dashboard", "listings", "analytics", "messages", "properties", "referrals", "settings"].includes(suite)) throw new Error(`Unknown suite: ${suite}`);
