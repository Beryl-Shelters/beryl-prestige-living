...
export function runSuites(suites = ["auth", "dashboard", "listings", "analytics", "messages"]) {
  for (const suite of suites) {
    if (!["auth", "dashboard", "listings", "analytics", "messages"].includes(suite)) throw new Error(`Unknown suite: ${suite}`);
