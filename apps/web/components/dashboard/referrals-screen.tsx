...
export function ReferralsScreen(){
  ...
  return <section className="referrals-page">
    ...
    <div className="referrals-intro">
      <section className="dashboard-card referrals-earn"><h2>Earn with Beryl Prestige Livings</h2><p>Invite your friends to Beryl Prestige Livings and earn {rate}% of every property purchase they make through our platform. Start referring today and benefit from their investments!</p>
