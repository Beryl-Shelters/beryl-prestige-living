...
export const attachmentCreateInput=z.object({subject:text("Subject",160),message:z.string().trim().max(3000)}).strict();
export const attachmentReplyInput=z.object({message:z.string().trim().max(3000)}).strict();
