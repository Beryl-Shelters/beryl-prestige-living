...
const components = {
  ...
  schemas: {
    ...
    MarketplaceSellerPropertySummary: objectSchema({ id: uuid, referenceId: { type: "string" }, title: nullableString, askingPrice: { type: "number", minimum: 0, nullable: true }, status: { type: "string", enum: ["DRAFT", "IN_REVIEW", "LIVE", "REJECTED"] }, currentStep: { type: "string", enum: ["PROPERTY_INFORMATION", "PHOTOS_DOCUMENTS", "SALES_MANDATE", "REVIEW"], nullable: true }, coverImage: { allOf: [ref("MarketplaceReviewImage")], nullable: true }, photoCount: { type: "integer", minimum: 0, maximum: 10 }, updatedAt: dateTime, submittedAt: { ...dateTime, nullable: true }, publishedAt: { ...dateTime, nullable: true, description: "Null until an authoritative Marketplace publication timestamp exists." }, rejectedAt: { ...dateTime, nullable: true, description: "Null until the Admin review lifecycle provides an authoritative rejection timestamp." }, rejectionFeedback: { type: "string", nullable: true, description: "Existing Seller-safe rejection_reason only; null for non-REJECTED properties." }, reviewProgress: { type: "object", nullable: true, properties: { submitted: { type: "boolean" }, reviewing: { type: "boolean" }, live: { type: "boolean" } }, additionalProperties: false }, nextAction: { type: "string", enum: ["CONTINUE_PROPERTY_INFORMATION", "CONTINUE_PHOTOS_DOCUMENTS", "CONTINUE_SALES_MANDATE", "CONTINUE_REVIEW", "VIEW_REVIEW_STATUS", "VIEW_LIVE_LISTING", "VIEW_REJECTION"] } }, ["id", "referenceId", "status", "currentStep", "coverImage", "photoCount", "updatedAt", "submittedAt", "publishedAt", "rejectedAt", "rejectionFeedback", "reviewProgress", "nextAction"]),
