...
const components = {
  ...
  schemas: {
    ...
    AdminLeadDetail: { type: "object", description: "Operational Admin lead detail, including bounded referrer identity when the customer has an authoritative referred-by relationship. Customer contact information is limited to the inquiry/customer profile; Seller-private documents and full addresses are excluded.", additionalProperties: true },
