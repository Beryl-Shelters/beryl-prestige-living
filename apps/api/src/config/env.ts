...
export const env = {
  ...
  adminLoginOtpExpiryMinutes: Number(process.env.ADMIN_LOGIN_OTP_EXPIRY_MINUTES || 10),
  adminLoginOtpMaxAttempts: Number(process.env.ADMIN_LOGIN_OTP_MAX_ATTEMPTS || 3),
  adminLoginOtpResendCooldownSeconds: Number(process.env.ADMIN_LOGIN_OTP_RESEND_COOLDOWN_SECONDS || 60),
  adminPasswordChangeProofExpiresIn: Number(process.env.ADMIN_PASSWORD_CHANGE_PROOF_EXPIRES_IN || 600),
