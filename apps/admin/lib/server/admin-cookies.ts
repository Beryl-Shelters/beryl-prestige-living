...
export const ADMIN_COOKIES = { access: "beryl_admin_access", refresh: "beryl_admin_refresh", changePassword: "beryl_admin_change_password", setupPassword: "beryl_admin_setup_password", state: "beryl_admin_state" } as const;
...
export function setSetupPasswordProof(response: NextResponse, token: string, expiresIn: number) { response.cookies.set(ADMIN_COOKIES.setupPassword, token, secureOptions(expiresIn)); }
